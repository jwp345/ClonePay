...
public class FirmBankingRequest {
    ...
    @Getter
    private final String fromBankAccountNumber; // enum
    ...
    public static FirmBankingRequest generateFirmbankingRequest(
            FirmbankingReuqestId firmbankingReuqestId,
        ...
        return new FirmBankingRequest(
                firmbankingReuqestId.getFirmbankingReuqestId(),
    ...
    @Value
    public static class FirmbankingReuqestId {
        public FirmbankingReuqestId(String value) {
            this.firmbankingReuqestId = value;
        }
        String firmbankingReuqestId;
    }
